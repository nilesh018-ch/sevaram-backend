...
export const products = {
  ...
  categoryProducts: {
    fruits: [
      ...
      { name: "Pomegranate", price: "Enquire", image: pomegranateImg, description: "Juicy red pomegranates with high antioxidant value." },
      { name: "Grapes (Green)", price: "Enquire", image: grapesGreenImg, description: "Fresh seedless green grapes." },
      ...
      { name: "Apple", price: "Enquire", image: appleImg, description: "Crisp and fresh export-grade apples." },
      { name: "Orange", price: "Enquire", image: orangeImg, description: "Juicy oranges packed with Vitamin C." },
      ...
      { name: "Papaya", price: "Enquire", image: papayaImg, description: "Ripe and healthy papayas." },
