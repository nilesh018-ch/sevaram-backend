...
export const products = {
  ...
  categoryProducts: {
    ...
    vegetables: [
      ...
      { name: "Green Chillies", price: "Enquire", image: greenChilliesImg, description: "Spicy and vibrant green chillies, harvested fresh to maintain their heat and color. These chillies are essential for adding flavor and spice to various international dishes. Packed under controlled conditions to preserve their crispness and pungency.", subCategory: "🌶️ High-Demand Export Vegetables" },
      { name: "Red Chillies (Fresh)", price: "Enquire", image: redChilliesImg, description: "Vibrant red chillies with a high heat index, perfect for making sauces, pastes, and seasonings. Our fresh red chillies are selected for their uniform color and intense flavor. We ensure proper ventilation in packaging to prevent moisture buildup.", subCategory: "🌶️ High-Demand Export Vegetables" },
